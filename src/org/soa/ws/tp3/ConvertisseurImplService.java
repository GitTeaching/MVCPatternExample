 ...
 * 
 */
@WebServiceClient(name = "ConvertisseurImplService", targetNamespace = "http://tp3.ws.soa.org/", wsdlLocation = "http://hedia:8080/ConvertisseurWS/ConvertisseurImplService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://hedia:8080/ConvertisseurWS/ConvertisseurImplService?wsdl");
    ...
    public Convertisseur getConvertisseurImplPort() {
        return super.getPort(new QName("http://tp3.ws.soa.org/", "ConvertisseurImplPort"), Convertisseur.class);
    }
    ...
    public Convertisseur getConvertisseurImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tp3.ws.soa.org/", "ConvertisseurImplPort"), Convertisseur.class, features);
    }
